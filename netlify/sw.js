...
(() => {
  ...
  var messages = {
    ...
    "range-not-satisfiable": ({ size, start: start2, end }) => {
      return `The start (${start2}) and end (${end}) values in the Range are not satisfiable by the cached response, which is ${size} bytes.`;
    },
...
`;
  ...
  function renderElement(name, { props: _props, children = "" }, shouldEscape = true) {
    const _a = _props, { lang: _2, "data-astro-id": astroId, "define:vars": defineVars } = _a, props = __objRest(_a, ["lang", "data-astro-id", "define:vars"]);
    if (defineVars) {
      if (name === "style") {
        if (props["is:global"]) {
...
Rename your file to \`[...page].astro\` or customize the param name via the \`paginate([], {param: '...'}\` option.`);
  ...
  self.skipWaiting();
  clientsClaim();
  precacheAndRoute([{ "revision": "b595545a775e84c0348363c960ea6bdc", "url": "assets/asset.3211c58f.css" }, { "revision": "c62040ac01d4f976fd33bd7b16c1d515", "url": "entry.64b5e880.js" }, { "revision": "c62040ac01d4f976fd33bd7b16c1d515", "url": "entry.64b5e8802.js" }, { "revision": "c62040ac01d4f976fd33bd7b16c1d515", "url": "entry.64b5e8803.js" }, { "revision": "9ba77f47e1a641d285664b1b7164b9b4", "url": "puppy.png" }]);
  ...
  var $$metadata$2 = createMetadata("/src/pages/index.astro", { modules: [], hydratedComponents: [], clientOnlyComponents: [], hydrationDirectives: /* @__PURE__ */ new Set([]), hoisted: [{ type: "inline", value: `
  ...
  var $$metadata$1 = createMetadata("/src/pages/networkonly.astro", { modules: [], hydratedComponents: [], clientOnlyComponents: [], hydrationDirectives: /* @__PURE__ */ new Set([]), hoisted: [{ type: "inline", value: `
		navigator.serviceWorker.register('/sw.js');
		let refreshing = false;
  ...
  var $$metadata = createMetadata("/src/pages/about.astro", { modules: [], hydratedComponents: [], clientOnlyComponents: [], hydrationDirectives: /* @__PURE__ */ new Set([]), hoisted: [{ type: "inline", value: `
		navigator.serviceWorker.register('/sw.js');
		let refreshing = false;

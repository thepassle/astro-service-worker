(() => {
  ...
  // service-worker-integration/shim.js
  var init_shim = __esm({
    "service-worker-integration/shim.js"() {
      self.process = { env: {}, argv: [] };
...
`;
  ...
  var $$metadata = createMetadata("/src/pages/index.astro", { modules: [], hydratedComponents: [], clientOnlyComponents: [], hydrationDirectives: /* @__PURE__ */ new Set([]), hoisted: [] });
  var $$Astro = createAstro("/src/pages/index.astro", "https://astro.build", "file:///Users/au87xu/astro-net/");
  ...
  function deserializeManifest(serializedManifest) {
    ...
    for (const serializedRoute of serializedManifest.routes) {
      routes.push(__spreadProps$2(__spreadValues$4({}, serializedRoute), {
    ...
    return __spreadProps$2(__spreadValues$4({}, serializedManifest), {
      assets,
      routes
    });
  }
...
Rename your file to \`[...page].astro\` or customize the param name via the \`paginate([], {param: '...'}\` option.`);
  ...
  async function call(mod, opts) {
    const paramsAndPropsResp = await getParamsAndProps(__spreadProps2(__spreadValues2({}, opts), { mod }));
...
This is generally NOT safe. Learn more at https://bit.ly/wb-precache`;
  ...
  // netlify/functions/entry2.mjs
  init_shim();
  var pageMap = /* @__PURE__ */ new Map([["src/pages/index.astro", _page0], ["src/pages/networkonly-endpoint.js", _page1], ["src/pages/foo.js", _page2]]);
  var renderers = [];
